...
public class Constantes {
    ...
    public static final String STATUS_CODE_RESPONSE = "Status Code Response";
    public static final int STATUS_CODE_INTERNAL_SUCCESS = 200;
    public static final String RESP_CREATE_ACCOUNT = "Response Create Account";
